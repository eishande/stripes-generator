...
Dataset.create!(user_id: 1, name: "Steps Per Day Sample", data: [7397,5403,7848,5003,8187,9347,8533,7922,8431,7878,9191,5016,6903,9215,6178,7361,7642,5603,7939,8877,9523,5810,5775,7490,6759,6927,5752,9250,5003,8573,7902,9416,8355,9085,7589,5552,9408,7028,9125,8531,9716,9688,6922,6775,7891,7213,6737,5312,8980,9457])
Pattern.create!(user_id: 1, dataset_id: 2,
                 colors: ["#1b9e77",
                          "#d95f02",
                          "#7570b3",
                          "#e7298a",
...
Dataset.create!(user_id: 1, name: "Snowfall Sample", data: [52,63,89,82,25,20,33,58,95,91,16,108,97,81,48,46,14,110,34,67,79,90,66,67,19,13,105,60,77,74])
Pattern.create!(user_id: 1, dataset_id: 3,
                colors: ["#ffffcc",
                         "#c2e699",
                         "#78c679",
                         "#31a354",
